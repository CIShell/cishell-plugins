...
public class TryIntegrationTest {
	...
	public static void ensureConnection() throws Exception {
		if (connection == null) {
			...
			/*try{
			for(Bundle o: Activator.getContext().getBundles()){

				if(o.getState() != 32 && !o.getSymbolicName().equals("org.eclipse.osgi.framework.log.FrameworkLog")){
					o.start();	
				}
				System.out.println("Bundle :"+o.getSymbolicName()+": " +o.getState());	
			}
			}catch(Exception e){
				e.printStackTrace();
			}*/
			...
			for(Object o: Activator.getContext().getAllServiceReferences(null,null)){
				System.out.println("Services :"+o);	
			}		
